...
if($_SERVER["REQUEST_METHOD"] == "POST")   	
{
	...
	else 
	{
		...
		{
			$sql = "SELECT director_id FROM iqac_director WHERE director_email = ?";
	...
	if(empty($name_err) && empty($email_err) && empty($password_err) && empty($cpassword_err))
	{
		...
		$query = "insert into iqac_director (director_name, director_email, director_password) values ('$name', '$email', '$hash_password')";

		if(mysqli_query($con, $query))
        {
            echo '<script language="javascript">';
            echo'alert("IQAC Director Added Successfully."); location.href="add_director.php"';
            echo '</script>';
        }
        else
        {
            echo '<script language="javascript">';
           	echo'alert("Failed, Please Try Again."); location.href="add_director.php"';
            echo '</script>';
        }
        mysqli_close($con);
	}
                ...
                <div class="container-fluid">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">IQAC Director</li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <div class="card-body">
                        	<ul class="nav nav-tabs">
	                    		<li class="nav-item" role="presentation">
	                        		<a class="nav-link active" href="add_director.php" id="active">Add IQAC Director</a>
	                    		</li>

	                    		<li class="nav-item" role="presentation">
	                        		<a class="nav-link" href="manage_director.php" id="non-active">Manage IQAC Director</a>
	                    		</li>
	                		</ul>
										...
										<div class="col-sm-6 col-sm-6">
											<div class="card" style="border-top:2px solid #087ec2;">
												<div class="card-header" style="color:#087ec2; font-weight:bold;">
		                            				...
		                            				<span>Add New IQAC Director</span>
		                        				</div>	
		                        				<div class="card-body">
