...
if (isset($_GET['delete'])) 
{
    ...
    $sql = "SELECT * FROM cri_4_4_1_doc_upload WHERE doc_id = '$id'";
    $data = $con->query($sql);
    ...
    {
    	$sql = "DELETE FROM cri_4_4_1_doc_upload WHERE doc_id = '$id'";
    	if ($con->query($sql) === TRUE) 
	    {
	        echo '<script language="javascript">';
        	echo'alert("Document Deleted Successfully."); location.href="cri_4.4.1_doc_view.php"';
        	echo '</script>';
	    } 
    }
    else
    {
    	echo '<script language="javascript">';
        echo'alert("Document Deleted Failed, Please Try Again."); location.href="cri_4.4.1_doc_view.php"';
        echo '</script>';
    }
}
?>
				...
				<div class="container-fluid">
					<div class="card" style="border-top:2px solid #087ec2;">
						...
						<div class="card-header" style="color:#087ec2; font-weight:bold;">
							...
							<span>Criteria 4.4.1 - Expenditure incurred on maintenance of physical and academic support facilities, excluding salary component, during the year (INR in lakhs).</span>
						</div>
						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_4.4.1_doc_upload.php" id="non-active">Upload Document</a>
								</li>

								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_4.4.1_doc_view.php" id="active">View Document</a>
								</li>
                            	...
                            	<table class="table table-bordered" id="table">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM cri_4_4_1_doc_upload WHERE upload_by_id = '$upload_by_id' ORDER BY doc_id";   
