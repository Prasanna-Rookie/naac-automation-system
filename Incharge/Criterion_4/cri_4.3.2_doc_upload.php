...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	if(empty($academic_year_err) && empty($description_err) && empty($pdf_file_err))
	{
		...
		{
			$query = "INSERT INTO cri_4_3_2_doc_upload (academic_year, description, upload_by_id, upload_by_name, doc_name) VALUES ('$academic_year', '$description', '$upload_by_id', '$upload_by_name','$pdf_file_name')";
			if(mysqli_query($con, $query))
			{
				echo '<script language="javascript">';
        		echo'alert("Document Uploaded Successfully."); location.href="cri_4.3.2_doc_upload.php"';
        		echo '</script>';
			}
			else
			{
				echo '<script language="javascript">';
	        	echo'alert("Document Upload Failed, Please Try Again."); location.href="cri_4.3.2_doc_upload.php"';
	        	echo '</script>';
			}
		}
	}
					...
					<div class="card" style="border-top:2px solid #087ec2;">
						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_4.3.2_doc_upload.php" id="active">Upload Document</a>
								</li>
										...
										<div class="col-sm-6 col-sm-6">
											<div class="card" style="border-top:2px solid #087ec2;">
												<div class="card-header" style="color:#087ec2; font-weight:bold;">
	                        						...
	                        						<span>Criteria 4.3.2 - Upload Document</span>
												</div>
												<div class="card-body">
