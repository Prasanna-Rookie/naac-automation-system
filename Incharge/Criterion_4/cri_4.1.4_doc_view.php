...
if (isset($_GET['delete'])) 
{
    ...
    $sql = "SELECT * FROM cri_4_1_4_infrastructure_expenditure WHERE exp_id = '$id'";
    $data = $con->query($sql);
    ...
    {
    	$sql = "DELETE FROM cri_4_1_4_infrastructure_expenditure WHERE exp_id = '$id'";
    	if ($con->query($sql) === TRUE) 
	    {
	        echo '<script language="javascript">';
        	echo'alert("Document Deleted Successfully."); location.href="cri_4.1.4_doc_view.php"';
        	echo '</script>';
	    } 
    }
    else
    {
    	echo '<script language="javascript">';
        echo'alert("Document Deleted Failed, Please Try Again."); location.href="cri_4.1.4_doc_view.php"';
        echo '</script>';
    }
}
						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_4.1.4_infrastructure_expenditure.php" id="non-active">Expenditure for infrastructure</a>
								</li>

								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_4.1.4_doc_view.php" id="active">View Document</a>
								</li>
                            	...
                            	<table class="table table-bordered" id="table">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM cri_4_1_4_infrastructure_expenditure WHERE upload_by_id = '$upload_by_id' ORDER BY exp_id";   
                                                ...
                                                { 
                                        			...
                                        			<tr style="text-align:center;">
                                                        ...
                                                        <td>
                                                        	...
                                                        	<?php
                                                        		echo "
																	<a href='?delete={$data['exp_id']}' class='btn btn-danger'><i class='fa-solid fa-trash-can'></i></a>"; 
