						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_4.1.3_ict_classrooms.php" id="non-active">Classrooms and Seminar Halls</a>
								</li>
                            	...
                            	<table class="table table-bordered" id="table">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM cri_4_1_3_classrooms_seminarhalls WHERE upload_by_id = '$upload_by_id' ORDER BY class_id";   
