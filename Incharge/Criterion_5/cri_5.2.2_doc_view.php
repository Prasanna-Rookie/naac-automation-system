...
if (isset($_GET['delete'])) 
{
    ...
    if(unlink($upload_location))
    {
    	...
    	if ($con->query($sql) === TRUE) 
	    {
        	...
        	echo'alert("Document Deleted Successfully."); location.href="cri_5.2.2_doc_view.php"';
        	echo '</script>';
	    } 
    }
    else
    {
    	echo '<script language="javascript">';
        echo'alert("Document Deleted Failed, Please Try Again."); location.href="cri_5.2.2_doc_view.php"';
        echo '</script>';
    }
}
?>
					...
					<div class="card" style="border-top:2px solid #087ec2;">
						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_5.2.2_doc_view.php" id="active">View Document</a>
								</li>
                            	...
                            	<table class="table table-bordered" id="table">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM cri_5_doc_upload WHERE upload_by_id = '$upload_by_id' and criteria = 'Metric 5.2.2' ORDER BY doc_id";   
