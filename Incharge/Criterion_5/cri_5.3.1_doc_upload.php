	...
	if(empty($academic_year_err) && empty($description_err) && empty($pdf_file_err))
	{
		...
		if(move_uploaded_file($pdf_file_pdf_tem_loc, $pdf_file_upload_location))
		{
			...
			if(mysqli_query($con, $query))
			{
        		...
        		echo'alert("Document Uploaded Successfully."); location.href="cri_5.3.1_doc_upload.php"';
        		echo '</script>';
			}
			else
			{
				echo '<script language="javascript">';
	        	echo'alert("Document Upload Failed, Please Try Again."); location.href="cri_5.3.1_doc_upload.php"';
	        	echo '</script>';
			}
		}
	}
						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_5.3.1_data_entry.php" id="non-active">Awards and Medals</a>
								</li>

								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_5.3.1_doc_upload.php" id="active">Upload Document</a>
								</li>
										...
										<div class="col-sm-6 col-sm-6">
											<div class="card" style="border-top:2px solid #087ec2;">
												<div class="card-header" style="color:#087ec2; font-weight:bold;">
	                        						...
	                        						<span>Criteria 5.3.1 - Upload Document</span>
												</div>
												<div class="card-body">
