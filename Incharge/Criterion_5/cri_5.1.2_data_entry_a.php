...
require '../../config.php';
$academic_year = $academic_year_err = $scheme_name = $scheme_name_err = $no_students = $no_students_err = $amount = $amount_err = $agency_name = $agency_name_err = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	{
		$agency_name_err = "Please Enter Name of the NGO/Agency.";
	}
	else
	{
	...
	// Insert
	if(empty($academic_year_err) && empty($scheme_name_err) && empty($no_students_err) && empty($amount_err) && empty($agency_name_err))
	{
		$type = "Non-Government";
		$query = "INSERT INTO cri_5_1_1_scholarships (academic_year, upload_by_id, upload_by_name, type, scheme_name, no_students, amount, agency_name) VALUES ('$academic_year', '$upload_by_id', '$upload_by_name', '$type','$scheme_name', '$no_students', '$amount', '$agency_name')";
		if(mysqli_query($con, $query))
		{
			echo '<script language="javascript">';
			echo'alert("Uploaded Successfully."); location.href="cri_5.1.2_data_entry_a.php"';
			echo '</script>';
		}
		else
		{
			echo '<script language="javascript">';
			echo'alert("Upload Failed, Please Try Again."); location.href="cri_5.1.2_data_entry_a.php"';
			echo '</script>';
		}
...
if(isset($_POST['update']))
{
	...
	if(empty(trim($_POST["scheme_name"])) || empty(trim($_POST["no_students"])) || !is_numeric(trim($_POST["no_students"])) || empty(trim($_POST["amount"])) || !is_numeric(trim($_POST["amount"])) || empty(trim($_POST["agency_name"])))
	{
		$err++;
		echo '<script language="javascript">';
        echo'alert("Please Fill the all Fields."); location.href="cri_5.1.2_data_entry_a.php"';
        echo '</script>';
	}
	else
	{
		if($err == 0)
		{
			...
			$query = "UPDATE cri_5_1_1_scholarships SET scheme_name = ?, no_students = ?, amount = ?, agency_name = ? WHERE s_id = ?";
			$stmt = mysqli_prepare($con, $query);
			mysqli_stmt_bind_param($stmt, "sdssi", $scheme_name, $no_students, $amount, $agency_name, $id);
			if(mysqli_stmt_execute($stmt)) 
			{
			    echo '<script language="javascript">';
			    echo 'alert("Update Successfully."); location.href="cri_5.1.2_data_entry_a.php"';
			    echo '</script>';
			} 
			else 
			{
			    echo '<script language="javascript">';
			    echo 'alert("Update Failed, Please Try Again."); location.href="cri_5.1.2_data_entry_a.php"';
			    echo '</script>'; 
			}
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label" style="font-size: 17px; color:dimgrey; font-weight: bold;" for = "agency_name"> <span style="color: red">* </span>Name of the NGO/Agency</label>
						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_5.1.2_data_entry.php" id="non-active">Institution</a>
								</li>

								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_5.1.2_data_entry_a.php" id="active">Non-Government</a>
								</li>
											...
											<div class="col-sm-6 col-sm-6">
												<div class="card" style="border-top:2px solid #087ec2;">
													...
													<div class="card-body">
														...
														<div class="mb-3">
															<label class="form-label" for = "no_students"> <span style="color: red">* </span>Number of students receiving scholarships and freeships provided by non-government agencies</label>
											...
											<div class="col-sm-6 col-sm-6">
												<div class="card" style="border-top:2px solid #087ec2;">
													...
													<div class="card-body">
														...
														<div class="mb-3">
															<label class="form-label" for = "agency_name"> <span style="color: red">* </span>Name of the NGO/Agency</label>
							...
							<?php
							$sql = "SELECT * FROM cri_5_1_1_scholarships WHERE upload_by_id = '$upload_by_id' and type = 'Non-Government'";
							$datas = $con->query($sql);
							if($datas->num_rows>0)
							{
								?>
									...
									<table class="table table-bordered" id="table">
										<thead style="background-color:#057EC5; color:#FFF;">
											<tr align="center">
												...
												<th>Number of students receiving scholarships and freeships provided by non-government agencies</th>
												<th>Amount</th>
