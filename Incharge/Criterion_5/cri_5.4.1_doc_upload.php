...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	else
	{
        ...
        $pdf_file_upload_location = "../../Uploaded Documents/Criteria - 5/".$pdf_file_name;
	}

	// Insert
	if(empty($academic_year_err) && empty($description_err) && empty($pdf_file_err))
	{
		$criteria = "Metric 5.4.1";
		if(move_uploaded_file($pdf_file_pdf_tem_loc, $pdf_file_upload_location))
		{
			$query = "INSERT INTO cri_5_doc_upload (academic_year,criteria, description, upload_by_id, upload_by_name, doc_name) VALUES ('$academic_year', '$criteria','$description', '$upload_by_id', '$upload_by_name','$pdf_file_name')";
			if(mysqli_query($con, $query))
			{
				echo '<script language="javascript">';
        		echo'alert("Document Uploaded Successfully."); location.href="cri_5.4.1_doc_upload.php"';
        		echo '</script>';
			}
			else
			{
				echo '<script language="javascript">';
	        	echo'alert("Document Upload Failed, Please Try Again."); location.href="cri_5.4.1_doc_upload.php"';
	        	echo '</script>';
			}
		}
	}
				...
				<div class="container-fluid">
					<div class="card" style="border-top:2px solid #087ec2;">
						...
						<div class="card-header" style="color:#087ec2; font-weight:bold;">
							...
							<span>Criteria 5.4.1 - The Alumni Association and its Chapters (registered and functional) contribute significantly to the development of the institution through financial and other support services.</span>
						</div>
						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_5.4.1_doc_upload.php" id="active">Upload Document</a>
								</li>

								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_5.4.1_doc_view.php" id="non-active">View Document</a>
								</li>
										...
										<div class="col-sm-6 col-sm-6">
											<div class="card" style="border-top:2px solid #087ec2;">
												<div class="card-header" style="color:#087ec2; font-weight:bold;">
	                        						...
	                        						<span>Criteria 5.4.1 - Upload Document</span>
												</div>
												<div class="card-body">
