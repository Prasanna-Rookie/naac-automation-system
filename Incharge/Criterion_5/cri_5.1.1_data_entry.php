...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	if(empty($academic_year_err) && empty($scheme_name_err) && empty($no_students_err) && empty($amount_err))
	{
		...
		if(mysqli_query($con, $query))
		{
			...
			echo'alert("Uploaded Successfully."); location.href="cri_5.1.1_data_entry.php"';
			echo '</script>';
		}
		else
		{
			echo '<script language="javascript">';
			echo'alert("Upload Failed, Please Try Again."); location.href="cri_5.1.1_data_entry.php"';
			echo '</script>';
		}
...
if(isset($_POST['update']))
{
	...
	if(empty(trim($_POST["scheme_name"])) || empty(trim($_POST["no_students"])) || !is_numeric(trim($_POST["no_students"])) || empty(trim($_POST["amount"])) || !is_numeric(trim($_POST["amount"])))
	{
		$err++;
		echo '<script language="javascript">';
        echo'alert("Please Fill the all Fields."); location.href="cri_5.1.1_data_entry.php"';
        echo '</script>';
	}
	else
	{
		if($err == 0)
		{
			...
			{
			    echo '<script language="javascript">';
			    echo 'alert("Update Successfully."); location.href="cri_5.1.1_data_entry.php"';
			    echo '</script>';
			} 
			else 
			{
			    echo '<script language="javascript">';
			    echo 'alert("Update Failed, Please Try Again."); location.href="cri_5.1.1_data_entry.php"';
			    echo '</script>'; 
			}
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label" style="font-size: 17px; color:dimgrey; font-weight: bold;" for = "no_students"> <span style="color: red">* </span>Number of students receiving scholarships and freeships provided by the Government</label>
				...
				<div class="container-fluid">
					<div class="card" style="border-top:2px solid #087ec2;">
						...
						<div class="card-header" style="color:#087ec2; font-weight:bold;">
							...
							<span>Criteria 5.1.1 - Number of students benefitted by scholarships and freeships provided by the Government during the year.</span>
						</div>
						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_5.1.1_data_entry.php" id="active">Scholarships and Freeships</a>
								</li>

								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_5.1.1_doc_upload.php" id="non-active">Upload Document</a>
								</li>

								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_5.1.1_doc_view.php" id="non-active">View Document</a>
								</li>
										...
										<div class="row justify-content-center">
											<div class="col-sm-6 col-sm-6">
												<div class="card" style="border-top:2px solid #087ec2;">
													<div class="card-header" style="color:#087ec2; font-weight:bold;">
														<i class="fa-solid fa-graduation-cap fa-lg"></i>
														<span>Criteria 5.1.1 - Scholarships and Freeships</span>
													</div>
													<div class="card-body">
														<div class="mb-3">
											...
											<div class="col-sm-6 col-sm-6">
												<div class="card" style="border-top:2px solid #087ec2;">
													...
													<div class="card-body">
														<div class="mb-3">
															<label class="form-label" for = "no_students"> <span style="color: red">* </span>Number of students receiving scholarships and freeships provided by the Government</label>
							...
							<?php
							$sql = "SELECT * FROM cri_5_1_1_scholarships WHERE upload_by_id = '$upload_by_id' and type = 'Government'";
							$datas = $con->query($sql);
							if($datas->num_rows>0)
							{
								?>
									...
									<table class="table table-bordered" id="table">
										<thead style="background-color:#057EC5; color:#FFF;">
											<tr align="center">
												...
												<th>Number of students receiving scholarships and freeships provided by the Government</th>
												<th>Amount</th>
												<th>Update</th>
											</tr>
										</thead>
