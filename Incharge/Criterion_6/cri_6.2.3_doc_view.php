						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_6.2.3_e_governance.php" id="non-active">E-governance</a>
								</li>
                            	...
                            	<table class="table table-bordered" id="table">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM cri_6_2_3_doc_upload WHERE upload_by_id = '$upload_by_id' ORDER BY doc_id";   
