...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	if(empty($academic_year_err) && empty($user_choice_err))
	{
		...
		if(mysqli_query($con, $query))
		{
        	...
        	echo'alert("Uploaded Successfully."); location.href="cri_7.1.6_option.php"';
        	echo '</script>';
		}
		else
		{
			echo '<script language="javascript">';
	        echo'alert("Document Upload Failed, Please Try Again."); location.href="cri_7.1.6_option.php"';
	        echo '</script>';
		}
	}
}
if(isset($_POST['update']))
{
	...
	if(empty(trim($_POST["water"])))
	{
		$err++;
		echo '<script language="javascript">';
        echo'alert("Please Enter Budget Allocated."); location.href="cri_7.1.6_option.php"';
        echo '</script>';
	}
	else
	{
		if($err == 0)
		{
			...
			if(mysqli_stmt_execute($stmt)) {
			    echo '<script language="javascript">';
			    echo 'alert("Update Successfully."); location.href="cri_7.1.6_option.php"';
			    echo '</script>';
			} else {
			    echo '<script language="javascript">';
			    echo 'alert("Update Failed, Please Try Again."); location.href="cri_7.1.6_option.php"';
			    echo '</script>'; 
			}
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-light" style="border-top:3.5px solid #087ec2;">
                        <h6 class="modal-title" id="exampleModalLabel" style="color:#057EC5;"><i class="fa fa-edit"></i><spam>Quality audits on environment and energy undertaken by the institution:</spam></h6>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                        <label style="font-size: 17px; color:dimgrey; font-weight: bold;" class="control-label" for="water"><span style="color: red">* </span>Quality audits on environment and energy undertaken by the institution:</label>

                        <select name="water" class="form-select" id="water">

                        	<option value="">---Select Quality audits on environment and energy undertaken by the institution:---</option>
				...
				<div class="container-fluid">
					<div class="card" style="border-top:2px solid #087ec2;">
						...
						<div class="card-header" style="color:#087ec2; font-weight:bold;">
							...
							<span>
                                Criteria 7.1.6 - Quality audits on environment and energy undertaken by the institution:
								<br>
                                    1) Green audit 
                                    2) Energy audit 
                                    3) Environment audit
						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_7.1.6_option.php" id="active">Options</a>
								</li>

								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_7.1.6_doc_upload.php" id="non-active">Upload Document</a>
								</li>

								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_7.1.6_doc_view.php" id="non-active">View Document</a>
								</li>
										...
										<div class="row justify-content-center">
											<div class="col-sm-6 col-sm-6">
												<div class="card" style="border-top:2px solid #087ec2;">
													<div class="card-header" style="color:#087ec2; font-weight:bold;">
														<i class="fa-solid fa-book-bookmark fa-lg"></i>
														<span>Criteria 7.1.6 -  Quality audits on environment and energy undertaken by the institution:</span>
													</div>
													<div class="card-body">
														<div class="mb-3">
														...
														<div class="mb-3">
                                                        	<label class="form-label" for="water"><span style="color: red">* </span> Quality audits on environment and energy undertaken by the institution:</label>
									...
									<table class="table table-bordered" id="table">
										<thead style="background-color:#057EC5; color:#FFF;">
											<tr align="center">
												<th>Academic Year</th>
												<th>Option</th>
												<th>Quality audits on environment</th>
												<th>Update</th>
											</tr>
										</thead>
