...
if (isset($_GET['delete'])) 
{
    ...
    $sql = "SELECT * FROM cri_1_2_2_doc_upload WHERE id = '$id'";
    $data = $con->query($sql);
    ...
    {
    	$sql = "DELETE FROM cri_1_2_2_doc_upload WHERE id = '$id'";
    	if ($con->query($sql) === TRUE) 
	    {
	        echo '<script language="javascript">';
        	echo'alert("Document Deleted Successfully."); location.href="cri_1.2.2_doc_view.php"';
        	echo '</script>';
	    } 
    }
    else
    {
    	echo '<script language="javascript">';
        echo'alert("Document Deleted Failed, Please Try Again."); location.href="cri_1.2.2_doc_view.php"';
        echo '</script>';
    }
}
					...
					<div class="card" style="border-top:2px solid #087ec2;">
						...
						<div class="card-body">
							<ul class="nav nav-tabs">
	                            ...
	                            <li class="nav-item" role="presentation">
	                                <a class="nav-link active" href="cri_1.2.2_doc_view.php" id="active">View Document</a>
	                            </li>
	                            <li class="nav-item" role="presentation">
                                    ...
                                    <tbody class="row_position">
                                        <?php 
                                            ...
                                            $sql = "SELECT pi.programme_name, du.academic_year, du.doc_name, pi.programme_name, du.upload_by, du.id 
                                                FROM cri_1_2_2_doc_upload AS du
