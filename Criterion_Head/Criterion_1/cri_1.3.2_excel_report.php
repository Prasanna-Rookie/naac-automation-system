                ...
                <div class="container-fluid">
                    <div class="card" style="border-top:2px solid #087ec2;">
                        ...
                        <div class="card-header" style="color:#087ec2; font-weight:bold;">
                            ...
                            <span> Criteria 1.3.2 - Number of value-added courses for imparting transferable and life skills offered during last five years.</span>
                        </div>
                        ...
                        <div class="card-body">
                            <ul class="nav nav-tabs">
	                            ...
	                            <li class="nav-item" role="presentation">
	                                <a class="nav-link active" href="cri_1.3.2_excel_report.php" id="active">Excel Report</a>
	                            </li>
	                            <li class="nav-item" role="presentation">
