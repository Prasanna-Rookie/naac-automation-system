...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	else
	{
        ...
        $pdf_file_upload_location = "../../Uploaded Documents/Criteria - 1/".$pdf_file_name;
	}
	...
	if(empty($academic_year_err) && empty($pdf_file_err))
	{
		...
		{
			$query = "INSERT INTO cri_1_2_2_doc_upload (academic_year, upload_by, doc_name) VALUES ('$academic_year', '$upload_by', '$pdf_file_name')";
			if(mysqli_query($con, $query))
			{
				echo '<script language="javascript">';
        		echo'alert("Document Uploaded Successfully."); location.href="cri_1.2.2_doc_upload.php"';
        		echo '</script>';
			}
			else
			{
				echo '<script language="javascript">';
	        	echo'alert("Document Upload Failed, Please Try Again."); location.href="cri_1.2.2_doc_upload.php"';
	        	echo '</script>';
			}
		}
		else
						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
	                                <a class="nav-link active" href="cri_1.2.2_doc_upload.php" id="active">Upload Document</a>
	                            </li>
	                            <li class="nav-item" role="presentation">
	                                <a class="nav-link" href="cri_1.2.2_doc_view.php" id="non-active">View Document</a>
	                            </li>
	                            <li class="nav-item" role="presentation">
	                                <a class="nav-link" href="cri_1.2.2_excel_report.php" id="non-active">Excel Report</a>
	                            </li>
	                            <li class="nav-item" role="presentation">
										...
										<div class="col-sm-6 col-sm-6">
											<div class="card" style="border-top:2px solid #087ec2;">
												<div class="card-header" style="color:#087ec2; font-weight:bold;">
	                        						...
	                        						<span>Criteria 1.2.2 - Upload Document</span>
												</div>
