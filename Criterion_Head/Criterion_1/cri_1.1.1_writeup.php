						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
	                                <a class="nav-link active" href="cri_1.1.1_writeup.php" id="active">Write Up</a>
	                            </li>
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_1.1.1_doc_view.php" id="non-active">View Document</a>
								</li>
