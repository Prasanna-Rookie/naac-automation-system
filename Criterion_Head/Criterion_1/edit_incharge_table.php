...
<div class="table-responsive">
    <table class="table table-bordered" id="table">
        ...
        <tbody>
        	<?php
        		require '../../config.php';
				$sql = "SELECT di.id,di.email,di.name,di.criterion,di.department,pi.programme_name FROM department_incharge AS di INNER JOIN programme_info as pi ON di.department = pi.programme_code WHERE criterion = 'Criterion - 1' ORDER BY di.criterion, pi.id, di.id";
				$res = $con->query($sql);
