                    ...
                    <div class="card" style="border-top:2px solid #087ec2;">
                        ...
                        <div class="card-body">
                            <ul class="nav nav-tabs">
	                            ...
	                            <li class="nav-item" role="presentation">
	                                <a class="nav-link active" href="cri_1.3.4_excel_report.php" id="active">Excel Report</a>
	                            </li>
                                        ...
                                        <div class="col-sm-6 col-sm-6">
                                            <div class="card" style="border-top:2px solid #087ec2;">
                                                <div class="card-header" style="color:#087ec2; font-weight:bold;">
                                                    ...
                                                    <span>Criteria 1.3.4 - Excel Report</span>
                                                </div>
                                        ...
                                        <thead style="background-color:#057EC5; color:#FFF;">
                                            <tr>
                                                <tr>
		                                            ...
		                                            <th>Program Code</th>
		                                            <th>Name of students undertaking field projects /internships/student projects</th>
		                                        </tr>
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody class="row_position">
                                            <?php 
                                                ...
                                                $sql = "SELECT    
														...
														LEFT JOIN cri_1_3_4_student_project AS cri 
														ON pi.programme_code = cri.department
														WHERE cri.stu_name IS NOT NULL AND cri.academic_year = '$academic_year'
														ORDER BY pi.id, cri.register_no";
