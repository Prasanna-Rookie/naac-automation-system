                    ...
                    <div class="card" style="border-top:2px solid #087ec2;">
                        ...
                        <div class="card-body">
                            <ul class="nav nav-tabs">
	                            ...
	                            <li class="nav-item" role="presentation">
	                                <a class="nav-link active" href="cri_1.3.3_excel_report.php" id="active">Excel Report</a>
	                            </li>
	                            <li class="nav-item" role="presentation">
                                        ...
                                        <div class="col-sm-6 col-sm-6">
                                            <div class="card" style="border-top:2px solid #087ec2;">
                                                <div class="card-header" style="color:#087ec2; font-weight:bold;">
                                                    ...
                                                    <span>Criteria 1.3.3 - Excel Report</span>
                                                </div>
                                        ...
                                        <tbody class="row_position">
                                            <?php 
                                                ...
                                                $sql = "SELECT    
														...
														LEFT JOIN cri_1_3_2_value_added_courses AS cri 
														ON pi.programme_code = cri.department
														WHERE cri.course_name IS NOT NULL and cri.academic_year = '$academic_year'
                                                ...
                                                if($datas->num_rows>0)
                                                {
                                                    ...
                                                    {  
                                                            ...
                                                            <td><?php echo $data['offered_time']; ?></td>
                                                            <td><?php echo $data['duration']; ?></td>
                                                            <td><?php echo $data['stu_enrolled']; ?></td>
                                                            <td><?php echo $data['stu_completed']; ?></td>
