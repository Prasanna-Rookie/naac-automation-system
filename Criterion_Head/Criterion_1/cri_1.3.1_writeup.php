...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	if(empty($academic_year_err) && empty($$writeup_err))
	{
		...
		if($id == 0)
		{
			$criteria = "Metric 1.3.1";
			$query = "INSERT INTO cri_1_write_up (academic_year, criteria, write_up) VALUES ('$academic_year', '$criteria', '$writeup')";

			if(mysqli_query($con, $query))
			{
				echo '<script language="javascript">';
	        	echo'alert("Write Up Updated Successfully."); location.href="cri_1.3.1_writeup.php"';
	        	echo '</script>';
			}
			else
			{
				echo '<script language="javascript">';
	        	echo'alert("Write Up Update Failed, Please Try Again."); location.href="cri_1.3.1_writeup.php"';
	        	echo '</script>';
			}
		}
		else
		{
			$query = "UPDATE cri_1_write_up SET write_up = '$writeup' WHERE id = '$id'";
			...
			{
				echo '<script language="javascript">';
	        	echo'alert("Write Up Update Failed, Please Try Again."); location.href="cri_1.1.1_writeup.php"';
	        	echo '</script>';
			}
		}
	}
						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
	                                <a class="nav-link active" href="cri_1.3.1_writeup.php" id="active">Write Up</a>
	                            </li>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea type = "text" class="form-control <?php echo (!empty($writeup_err)) ? 'is-invalid' : ''; ?>" name="writeup" id = "writeup">
	...
	<script>
	  $(document).ready(function(){
	     $('#academic_year').change(function(){
	      ...
	      var criteria = "Metric 1.3.1"; 
	 
	      $.ajax({
	        type: 'POST',
	        url: 'cri_1_writeup_fetch.php',
	        data: {
