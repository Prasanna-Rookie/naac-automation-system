                    ...
                    <div class="card" style="border-top:2px solid #087ec2;">
                        ...
                        <div class="card-body">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" href="cri_1.1.3_excel_report.php" id="active">Excel Report</a>
                                </li>
	                            <li class="nav-item" role="presentation">
                                        ...
                                        <div class="col-sm-6 col-sm-6">
                                            <div class="card" style="border-top:2px solid #087ec2;">
                                                <div class="card-header" style="color:#087ec2; font-weight:bold;">
                                                    ...
                                                    <span>Criteria 1.1.3 - Excel Report</span>
                                                </div>
                                    ...
                                    <table class="table table-bordered" id="table">
                                        <thead style="background-color:#057EC5; color:#FFF;">
                                            <tr>
                                                ...
                                                <th>Activities/Content with a direct bearing on Employability/ Entrepreneurship/ Skill development</th>
                                        ...
                                        <tbody class="row_position">
                                            <?php 
                                                ...
                                                $sql = "SELECT 
														...
														LEFT JOIN cri_1_1_3_course AS cri 
														ON pi.programme_code = cri.department
														WHERE cri.course_name IS NOT NULL
														ORDER BY pi.id, cri.academic_year";
