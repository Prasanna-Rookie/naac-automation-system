...
if (isset($_GET['delete'])) 
{
    ...
    if(unlink($upload_location))
    {
    	...
    	if ($con->query($sql) === TRUE) 
	    {
        	...
        	echo'alert("Document Deleted Successfully."); location.href="cri_3.2.1_doc_view.php"';
        	echo '</script>';
	    } 
    }
    else
    {
    	echo '<script language="javascript">';
        echo'alert("Document Deleted Failed, Please Try Again."); location.href="cri_3.2.1_doc_view.php"';
        echo '</script>';
    }
}
?>
				...
				<div class="container-fluid">
					<div class="card" style="border-top:2px solid #087ec2;">
						...
						<div class="card-header" style="color:#087ec2; font-weight:bold;">
							...
							<span>Criteria 3.2.1 - Number of teachers having research projects during the year.</span>
						</div>
						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_3.2.2_excel_report.php" id="non-active">Excel Report</a>
								</li>

								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_3.2.2_doc_upload.php" id="non-active">Upload Document</a>
								</li>

								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_3.2.2_doc_view.php" id="active">View Document</a>
								</li>
                            	...
                            	<table class="table table-bordered" id="table">
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            $sql = "SELECT * FROM cri_3_doc_upload WHERE criteria = 'Metric 3.2.2' ORDER BY academic_year, doc_id";   
