...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	if(empty($academic_year_err) && empty($writeup_err))
	{
		...
		if($id == 0)
		{
			$criteria = "Metric 3.3.1";
			// Prepare the SQL statement
			$query = "INSERT INTO cri_3_write_up (academic_year, criteria, write_up) VALUES (?, ?, ?)";
			...
			if (mysqli_stmt_execute($stmt)) {
			    ...
			    echo 'alert("Write Up Updated Successfully."); location.href="cri_3.3.1_writeup.php"';
			    echo '</script>';
			} else {
			    echo '<script language="javascript">';
			    echo 'alert("Write Up Update Failed, Please Try Again."); location.href="cri_3.3.1_writeup.php"';
			    echo '</script>';
			}
		...
		{
			// Prepare the SQL statement
			$query = "UPDATE cri_3_write_up SET write_up = ? WHERE id = ?";
						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_3.3.1_writeup.php" id="active">Write Up</a>
								</li>
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_3.3.1_doc_view.php" id="non-active">View Document</a>
								</li>
...
<script>
	$(document).ready(function(){
		$('#academic_year').change(function(){
			...
			var criteria = "Metric 3.3.1"; 

			$.ajax({
				type: 'POST',
				url: 'cri_3_writeup_fetch.php',
				data: {
