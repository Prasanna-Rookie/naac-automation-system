...
if (isset($_GET['delete'])) 
{
    ...
    $sql = "SELECT * FROM cri_3_doc_upload WHERE doc_id = '$id'";
    $data = $con->query($sql);
    while ($res = $data->fetch_assoc()) 
    {
    	$upload_location = "../../Uploaded Documents/Criteria - 3/".$res['doc_name'];
    }
    if(unlink($upload_location))
    {
    	$sql = "DELETE FROM cri_3_doc_upload WHERE doc_id = '$id'";
    	if ($con->query($sql) === TRUE) 
	    {
	        echo '<script language="javascript">';
        	echo'alert("Document Deleted Successfully."); location.href="cri_3.3.1_doc_view.php"';
        	echo '</script>';
	    } 
    }
    else
    {
    	echo '<script language="javascript">';
        echo'alert("Document Deleted Failed, Please Try Again."); location.href="cri_3.3.1_doc_view.php"';
        echo '</script>';
    }
}
?>
				...
				<div class="container-fluid">
					<div class="card" style="border-top:2px solid #087ec2;">
						...
						<div class="card-header" style="color:#087ec2; font-weight:bold;">
							...
							<span>Criteria 3.3.1 - Institution has created an ecosystem for innovations and creation and transfer of knowledge supported by dedicated centres for research, entrepreneurship,community orientation, incubation, etc.</span>
						</div>
						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_3.3.1_writeup.php" id="non-active">Write Up</a>
								</li>

								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_3.3.1_doc_upload.php" id="non-active">Upload Document</a>
								</li>

								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_3.3.1_doc_view.php" id="active">View Document</a>
								</li>
                            	...
                            	<table class="table table-bordered" id="table">
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            $sql = "SELECT * FROM cri_3_doc_upload WHERE criteria = 'Metric 3.3.1' ORDER BY academic_year, doc_id";   
                                            ...
                                            if($datas->num_rows>0)
                                            {
                                                ...
                                                { 
                                                	$doc_name = "../../Uploaded Documents/Criteria - 3/".$data['doc_name'];
                                                    $i++;
                                        			?>
