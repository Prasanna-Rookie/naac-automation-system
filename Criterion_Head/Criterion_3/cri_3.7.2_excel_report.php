						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_3.7.2_excel_report.php" id="active">Excel Report</a>
								</li>
                                        ...
                                        <div class="col-sm-6 col-sm-6">
                                            <div class="card" style="border-top:2px solid #087ec2;">
                                                <div class="card-header" style="color:#087ec2; font-weight:bold;">
                                                    ...
                                                    <span>Criteria 3.7.2 - Report</span>
                                                </div>
                            			...
                            			<tbody class="row_position">
                            				<?php 
                            					...
                            					SELECT 
												    ...
												    details.month_year,
												    details.duration,
												    COALESCE(activities.activities, 'NIL') AS activities,
												    COALESCE(activities.no_of_students, 'NIL') AS no_of_students
												FROM 
												    cri_3_7_2_mou_activities AS activities
												RIGHT JOIN 
												    cri_3_7_2_mou_details AS details
												ON 
												    activities.name = details.name
												WHERE 
