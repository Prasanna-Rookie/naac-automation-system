	...
	if(empty($academic_year_err) && empty($writeup_err))
	{
		...
		if($id == 0)
		{
			...
			if (mysqli_stmt_execute($stmt)) {
			    ...
			    echo 'alert("Write Up Updated Successfully."); location.href="cri_3.6.1_writeup.php"';
			    echo '</script>';
			} else {
			    echo '<script language="javascript">';
			    echo 'alert("Write Up Update Failed, Please Try Again."); location.href="cri_3.6.1_writeup.php"';
			    echo '</script>';
			}
						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_3.6.1_writeup.php" id="active">Write Up</a>
								</li>
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_3.6.1_doc_view.php" id="non-active">View Document</a>
								</li>
