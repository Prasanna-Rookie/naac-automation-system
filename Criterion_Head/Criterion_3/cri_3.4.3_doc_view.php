						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_3.4.3_excel_report.php" id="non-active">Excel Report</a>
								</li>
                            	...
                            	<table class="table table-bordered" id="table">
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            $sql = "SELECT * FROM cri_3_doc_upload WHERE criteria = 'Metric 3.4.3' ORDER BY academic_year, doc_id";   
