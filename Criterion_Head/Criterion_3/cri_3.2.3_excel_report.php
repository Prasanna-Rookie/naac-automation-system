						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_3.2.3_excel_report.php" id="active">Excel Report</a>
								</li>
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_3.2.3_doc_view.php" id="non-active">View Document</a>
								</li>
                                        ...
                                        <div class="col-sm-6 col-sm-6">
                                            <div class="card" style="border-top:2px solid #087ec2;">
                                                <div class="card-header" style="color:#087ec2; font-weight:bold;">
                                                    ...
                                                    <span>Criteria 3.2.3 - Report</span>
                                                </div>
                            			...
                            			<tbody class="row_position">
                            				<?php 
                            					$sql = "SELECT 
													...
													teacher.research_guide,
													teacher.recognition_year,
													teacher.still_serving,
													COALESCE(scholar.scholar_name, 'NIL') AS scholar_name,
													COALESCE(scholar.registration_year, 'NIL') AS registration_year,
													COALESCE(scholar.title, 'NIL') AS title
													FROM 
													cri_2_4_2_teachers AS teacher
													LEFT JOIN 
													cri_3_4_2_scholar AS scholar
													ON 
													teacher.teacher_name = scholar.teacher_name
													WHERE 
	                                            ...
	                                            if($datas->num_rows>0)
	                                            {
	                                                ...
	                                                {  
	                                                    ...
	                                                    <tr>
	                                                        ...
	                                                        <td><?php echo $data['still_serving']; ?></td>
