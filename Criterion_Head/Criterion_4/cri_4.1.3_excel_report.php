						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_4.1.3_excel_report.php" id="active">Excel Report</a>
								</li>
                                        ...
                                        <div class="col-sm-6 col-sm-6">
                                            <div class="card" style="border-top:2px solid #087ec2;">
                                                <div class="card-header" style="color:#087ec2; font-weight:bold;">
                                                    ...
                                                    <span>Criteria 4.1.3 - Report</span>
                                                </div>
                            	...
                            	<div class="table-responsive">
                            		<table class="table table-bordered" id="table">
                            			<thead style="background-color:#057EC5; color:#FFF;">
                            				<tr>
                            					<th>Room number or Name  of classrooms/Seminar Hall with LCD / wifi/LAN facilities</th>
                            					<th>Type of ICT facility</th>
                            				</tr>
                            			</thead>
                            			<tbody class="row_position">
                            				<?php 
                            					$sql = "SELECT csh.room_no, csh.ict_facility FROM cri_4_1_3_classrooms_seminarhalls AS csh INNER JOIN programme_info as pi ON csh.department = pi.programme_code WHERE csh.academic_year = '$academic_year'ORDER BY pi.id, csh.class_id";
