						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_4.2.4_excel_report.php" id="active">Excel Report</a>
								</li>
                                        ...
                                        <div class="col-sm-6 col-sm-6">
                                            <div class="card" style="border-top:2px solid #087ec2;">
                                                <div class="card-header" style="color:#087ec2; font-weight:bold;">
                                                    ...
                                                    <span>Criteria 4.2.4 - Report</span>
                                                </div>
                            		...
                            		<table class="table table-bordered" id="table">
                            			<thead style="background-color:#057EC5; color:#FFF;">
                            				<tr>
                            					...
                            					<th>Total Number of students and teachers accessing the library per day</th>
                            				</tr>
                            			</thead>
                            			<tbody class="row_position">
                            				<?php 
	                                            ...
	                                            if($datas->num_rows>0)
	                                            {
	                                                ...
	                                                {  
	                                                    $total = $data['e_access'] + $data['teacher'] + $data['student'];
	                                                    ?>
	                                                    <tr>
