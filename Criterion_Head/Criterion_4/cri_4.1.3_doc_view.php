...
if (isset($_GET['delete'])) 
{
    ...
    $sql = "SELECT * FROM cri_4_1_3_classrooms_seminarhalls WHERE class_id = '$id'";
    $data = $con->query($sql);
    while ($res = $data->fetch_assoc()) 
    {
    	$upload_location = "../../Uploaded Documents/Criteria - 4/".$res['doc_name'];
    }
    if(unlink($upload_location))
    {
    	$sql = "DELETE FROM cri_4_1_3_classrooms_seminarhalls WHERE class_id = '$id'";
    	if ($con->query($sql) === TRUE) 
	    {
	        echo '<script language="javascript">';
        	echo'alert("Document Deleted Successfully."); location.href="cri_4.1.3_doc_view.php"';
        	echo '</script>';
	    } 
    }
    else
    {
    	echo '<script language="javascript">';
        echo'alert("Document Deleted Failed, Please Try Again."); location.href="cri_4.1.3_doc_view.php"';
        echo '</script>';
    }
}
?>
						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_4.1.3_excel_report.php" id="non-active">Excel Report</a>
								</li>

								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_4.1.3_doc_view.php" id="active">View Document</a>
								</li>
                            	...
                            	<table class="table table-bordered" id="table">
                            		<thead style="background-color:#057EC5; color:#FFF;">
                                        <tr>
                                            ...
                                            <th style="text-align:center;">Room Number or Name</th>
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $sql = "SELECT csh.class_id, csh.academic_year, csh.room_no, csh.ict_facility, csh.department, csh.doc_name, csh.upload_by_name, pi.programme_name FROM cri_4_1_3_classrooms_seminarhalls AS csh INNER JOIN programme_info as pi ON csh.department = pi.programme_code WHERE csh.upload_by_id = '$upload_by_id' ORDER BY csh.class_id";   
                                            ...
                                            if($datas->num_rows>0)
                                            {
                                                ...
                                                { 
                                                	$doc_name = "../../Uploaded Documents/Criteria - 4/".$data['doc_name'];
                                                    $i++;
                                        			?>
                                        			<tr style="text-align:center;">
                                                        ...
                                                        <td>
                                                        	...
                                                        	<?php
                                                        		echo "
																	<a href='?delete={$data['class_id']}' class='btn btn-danger'><i class='fa-solid fa-trash-can'></i></a>"; 
