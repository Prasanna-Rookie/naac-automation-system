<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST")    
    {
        ...
        if(empty($name_err) && empty($email_err) && empty($criterion_err) && empty($password_err) && empty($cpassword_err))
        {
            ...
            $query = "INSERT INTO incharge (email, name, criterion, password) values ('$email', '$name', '$criterion', '$hash_password')";

            if(mysqli_query($con, $query))
            {
                echo '<script language="javascript">';
                echo'alert(" Incharge Added Successfully."); location.href="add_incharge.php"';
                echo '</script>';
            }
            else
            {
                echo '<script language="javascript">';
                echo'alert("Failed, Please Try Again."); location.href="add_incharge.php"';
                echo '</script>';
            }
            mysqli_close($con);
        }
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" href="add_incharge.php" id="active">Add Incharge</a>
                                </li>

                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" href="manage_incharge.php" id="non-active">Manage Incharge</a>
                                </li>
                            </ul>
