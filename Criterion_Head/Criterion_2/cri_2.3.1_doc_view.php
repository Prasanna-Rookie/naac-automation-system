					...
					<div class="card" style="border-top:2px solid #087ec2;">
						...
						<div class="card-body">
							<ul class="nav nav-tabs">
	                            ...
	                            <li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_2.3.1_doc_view.php" id="active">View Document</a>
								</li>
							</ul><br>
                            	...
                            	<table class="table table-bordered" id="table">
                            		<thead style="background-color:#057EC5; color:#FFF;">
                                        <tr>
                                            ...
                                            <th style="text-align:center;">Experiential Learning</th>
                                            <th style="text-align:center;">Participative Learning</th>
                                            <th style="text-align:center;">Problem-Solving Methodologies</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php 
                                            ...
                                            $sql = "SELECT pi.programme_name, du.academic_year, du.exp_learning, du.par_learning, du.pro_solving
												FROM cri_2_3_1_doc_upload AS du
                                            ...
                                            if($datas->num_rows>0)
                                            {
                                                ...
                                                { 
                                                	$exp_learning = "../../Uploaded Documents/Criteria - 2/".$data['exp_learning'];

                                                	$par_learning = "../../Uploaded Documents/Criteria - 2/".$data['par_learning'];

                                                	$pro_solving = "../../Uploaded Documents/Criteria - 2/".$data['pro_solving'];
                                                    $i++;
                                        			?>
                                        			<tr style="text-align:center;">
                                                        ...
                                                        {
                                                        	echo $data['programme_name'];
                                                        }
                                                         
                                                    	?></td>
                                                        <td>
                                                        	<a href="<?php echo $exp_learning?>" class="btn btn-success" download><i class="fa-solid fa-download"></i></a>&nbsp;&nbsp;

                                                        	<a href="<?php echo $exp_learning ?>" target = "_blank" class="btn btn-danger"><span id="warning_btn"><i class="fa-solid fa-eye"></i></span></a>&nbsp;&nbsp;
                                                        </td>
                                                        <td>
                                                        	<a href="<?php echo $par_learning?>" class="btn btn-success" download><i class="fa-solid fa-download"></i></a>&nbsp;&nbsp;

                                                        	<a href="<?php echo $par_learning ?>" target = "_blank" class="btn btn-danger"><span id="warning_btn"><i class="fa-solid fa-eye"></i></span></a>&nbsp;&nbsp;
                                                        </td>
