						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_2.6.3_doc_view.php" id="active">View Document</a>
								</li>
								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_2.6.3_excel_report.php" id="non-active">Excel Report</a>
								</li>
							</ul><br>
                            	...
                            	<table class="table table-bordered" id="table">
                            		<thead style="background-color:#057EC5; color:#FFF;">
                                        <tr>
                                            ...
                                            <th style="text-align:center;">Student Name List</th>
                                            <th style="text-align:center;">Proof of the Result</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php 
                                            ...
                                            $sql = "SELECT pi.programme_name, du.academic_year, du.name_list, du.result_proof
												FROM cri_2_6_3_doc_upload AS du
                                            ...
                                            if($datas->num_rows>0)
                                            {
                                                ...
                                                { 
                                                	$name_list = "../../Uploaded Documents/Criteria - 2/".$data['name_list'];
                                                	$result_proof = "../../Uploaded Documents/Criteria - 2/".$data['result_proof'];
                                                    $i++;
                                        			?>
                                        			<tr style="text-align:center;">
                                                    	...
                                                    	?></td>
                                                        <td>
                                                        	<a href="<?php echo $name_list?>" class="btn btn-success" download><i class="fa-solid fa-download"></i></a>&nbsp;&nbsp;

                                                        	<a href="<?php echo $name_list ?>" target = "_blank" class="btn btn-danger"><span id="warning_btn"><i class="fa-solid fa-eye"></i></span></a>&nbsp;&nbsp;
                                                        </td>
                                                        <td>
                                                        	<a href="<?php echo $result_proof?>" class="btn btn-success" download><i class="fa-solid fa-download"></i></a>&nbsp;&nbsp;

                                                        	<a href="<?php echo $result_proof ?>" target = "_blank" class="btn btn-danger"><span id="warning_btn"><i class="fa-solid fa-eye"></i></span></a>&nbsp;&nbsp;
                                                        </td>
                                                    </tr>
                                                    <?php 
                                                }
