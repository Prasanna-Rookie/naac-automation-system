...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	if(empty($academic_year_err) && empty($writeup_err))
	{
		...
		if($id == 0)
		{
			$criteria = "Metric 2.6.1";
			// Prepare the SQL statement
			$query = "INSERT INTO cri_2_write_up (academic_year, criteria, write_up) VALUES (?, ?, ?)";
			...
			if (mysqli_stmt_execute($stmt)) {
			    ...
			    echo 'alert("Write Up Updated Successfully."); location.href="cri_2.6.1_writeup.php"';
			    echo '</script>';
			} else {
			    echo '<script language="javascript">';
			    echo 'alert("Write Up Update Failed, Please Try Again."); location.href="cri_2.6.1_writeup.php"';
			    echo '</script>';
			}
		...
		{
			// Prepare the SQL statement
			$query = "UPDATE cri_2_write_up SET write_up = ? WHERE id = ?";
						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
	                                <a class="nav-link active" href="cri_2.6.1_writeup.php" id="active">Write Up</a>
	                            </li>

	                            <li class="nav-item" role="presentation">
	                                <a class="nav-link" href="cri_2.6.1_doc_upload.php" id="non-active">Upload Document</a>
	                            </li>
	                            ...
	                            <!-- <div class="alert alert-primary" role="alert">
	                                <i class="fa-solid fa-circle-exclamation"></i>&nbsp;&nbsp;<strong>Present a write-up within a maximum of 200 words.</strong>
	                            </div> -->
	...
	<script>
	  $(document).ready(function(){
	     $('#academic_year').change(function(){
	      ...
	      var criteria = "Metric 2.6.1"; 
	 
	      $.ajax({
	        type: 'POST',
	        url: 'cri_2_writeup_fetch.php',
	        data: {
