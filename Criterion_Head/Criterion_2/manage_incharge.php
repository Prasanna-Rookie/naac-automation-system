<?php
    ...
    require '../../config.php';
    $email = $email_err = $name = $tname = $name_err = $department = $department_err = $criterion = $criterion_err = $password = $password_err = $cpassword = $cpassword_err = "";
    if($_SERVER["REQUEST_METHOD"] == "POST")    
    {
        ...
        else 
        {
            ...
            {
                $sql = "SELECT id FROM department_incharge WHERE email = ?";
        ...
        if(empty($name_err) && empty($email_err) && empty($criterion_err) && empty($department_err)&& empty($password_err) && empty($cpassword_err))
        {
            $hash_password = password_hash($password, PASSWORD_DEFAULT);

            $query = "INSERT INTO department_incharge (email, name, criterion, department, password) values ('$email', '$name', '$criterion', '$department', '$hash_password')";

            if(mysqli_query($con, $query))
            {
                echo '<script language="javascript">';
                echo'alert("Department Incharge Added Successfully."); location.href="manage_incharge.php"';
                echo '</script>';
            }
            else
            {
                echo '<script language="javascript">';
                echo'alert("Failed, Please Try Again."); location.href="manage_incharge.php"';
                echo '</script>';
            }
            mysqli_close($con);
        }
                ...
                <div class="container-fluid">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Manage Department Incharge</li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="container-fluid">
                    <div class="card" style="border-top:2px solid #087ec2;">
                        ...
                        <div class="card-header" style="color:#087ec2; font-weight:bold;">
                            ...
                            <span> Manage Department Incharge</span>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" href="manage_incharge.php" id="active">Add Department Incharge</a>
                                </li>

                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" href="edit_incharge.php" id="non-active">Manage Department Incharge</a>
                                </li>
                            </ul>
                                        ...
                                        <div class="col-sm-6 col-sm-6">
                                            <div class="card" style="border-top:2px solid #087ec2;">
                                                <div class="card-header" style="color:#087ec2; font-weight:bold;">
                                                    ...
                                                    <span>Add New Department Incharge</span>
                                                </div>  
                                                <div class="card-body">
