					...
					<div class="card" style="border-top:2px solid #087ec2;">
						...
						<div class="card-body">
							<ul class="nav nav-tabs">
	                            ...
	                            <li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_2.3.3_doc_view.php" id="active">View Document</a>
								</li>
								<li class="nav-item" role="presentation">
                            	...
                            	<table class="table table-bordered" id="table">
                            		<thead style="background-color:#057EC5; color:#FFF;">
                                        <tr>
                                            ...
                                            <th style="text-align:center;">Documents Type</th>
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            $sql = "SELECT pi.programme_name, du.academic_year, du.doc_type, du.doc_name
												FROM cri_2_3_3_doc_upload AS du
