						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
	                                <a class="nav-link" href="cri_2.7.1_doc_upload.php" id="non-active">Document Upload</a>
	                            </li>

	                            <li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_2.7.1_doc_view.php" id="active">View Document</a>
								</li>
							</ul><br>
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            $sql = "SELECT pi.programme_name, du.academic_year, du.doc_name
												FROM cri_2_7_1_doc_upload AS du
