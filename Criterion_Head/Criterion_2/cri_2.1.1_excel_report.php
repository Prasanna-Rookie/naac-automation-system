                ...
                <div class="card" style="border-top:2px solid #087ec2;">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" href="cri_2.1.1_excel_report.php" id="active">Excel Report</a>
                                </li>
                            ...
                            if($report_type == "Data Template")
                            {
                                ...
                                <?php
                                $sql = "SELECT pi.programme_code,pi.programme_name, cri.santioned_seats,cri.id, COUNT(*) as stu_count 
                                                ...
                                                { 
                                                    ...
                                                    if($i == $datas->num_rows)
                                                    {
                                                        ...
                                                        <tr>
                                                            <td></td>
                                                            <th>Total</th>
                                                            <th><?php echo $santioned_seats; ?></th>
                                                            <th><?php echo $stu_count  ;?></th>
                                                        </tr>
                                                        <?php
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="table">
                                        ...
                                        <tbody class="row_position">
                                            ...
                                            $sql = "SELECT cri_sd.reg_no, cri_sd.name
                                            FROM cri_2_1_1_student_details AS cri_sd
                                            INNER JOIN programme_info AS pi
