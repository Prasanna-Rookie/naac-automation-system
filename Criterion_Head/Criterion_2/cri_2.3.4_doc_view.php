						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
	                                <a class="nav-link" href="cri_2.3.4_writeup.php" id="non-active">Write Up</a>
	                            </li>

	                            <li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_2.3.4_doc_view.php" id="active">View Document</a>
								</li>
							</ul><br>
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            $sql = "SELECT pi.programme_name, du.academic_year, du.doc_name
												FROM cri_2_3_4_doc_upload AS du
