                        ...
                        <div class="card-body">
                            <ul class="nav nav-tabs">
	                            ...
	                            <li class="nav-item" role="presentation">
	                                <a class="nav-link" href="cri_2.1.1_excel_report.php" id="non-active">Excel Format Report</a>
	                            </li>
	                            <li class="nav-item" role="presentation">
                                    <a class="nav-link active" href="cri_2.1.1_student_list.php" id="active">Students List</a>
                                </li>
                                <!-- <li class="nav-item" role="presentation">
