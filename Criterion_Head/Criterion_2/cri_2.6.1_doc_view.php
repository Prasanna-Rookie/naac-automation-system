					...
					<div class="card" style="border-top:2px solid #087ec2;">
						...
						<div class="card-body">
							<ul class="nav nav-tabs">
	                            ...
	                            <li class="nav-item" role="presentation">
	                                <a class="nav-link active" href="cri_2.6.1_doc_view.php" id="active">View Document</a>
	                            </li>
							</ul><br>
                            	...
                            	<table class="table table-bordered" id="table">
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            $sql = "SELECT pi.programme_name, du.academic_year, du.doc_name
												FROM cri_2_6_1_doc_upload AS du
