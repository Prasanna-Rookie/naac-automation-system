						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_2.4.3_doc_upload.php" id="non-active">Document Upload</a>
								</li>
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_2.4.3_excel_report.php" id="active">Excel Report</a>
								</li>
										...
										<div class="col-sm-6 col-sm-6">
											<div class="card" style="border-top:2px solid #087ec2;">
												<div class="card-header" style="color:#087ec2; font-weight:bold;">
                                                    ...
                                                    <span>Criteria 2.4.3 - Report</span>
												</div>
							...
							if(!empty($academic_year))
							{
								...
								<div class="table-responsive">
									<table class="table table-bordered" id="table">
										...
										$sql = "SELECT t.name, t.pan, t.designation, t.joining_date, t.appointment, p.programme_name, t.leaving_date
												FROM cri_2_2_2_full_time_teacher AS t
												INNER JOIN programme_info AS p
												ON p.programme_code = t.department
												...
												if(count($experience_list) != 0)
													{
														...
														?>
															...
															<tr>
																...
																<td></td>
																<td></td>
																<th>Average Teaching Experience</th>
																<td><?php echo $average_duration; ?></td>
																<td></td>
															</tr>
														<?php
													}
