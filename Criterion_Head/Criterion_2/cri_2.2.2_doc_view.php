						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_2.2.2_doc_view.php" id="active">View Document</a>
								</li>

								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_2.2.2_pdf_report.php" id="non-active">PDF Report</a>
								</li>
							</ul><br>
                            	...
                            	<table class="table table-bordered" id="table">
                            		<thead style="background-color:#057EC5; color:#FFF;">
                                        <tr>
                                            ...
                                            <th style="text-align:center;">Teacher List</th>
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            $sql = "SELECT pi.programme_name, du.academic_year, du.teacher_list, du.student_list
                                            ...
                                            if($datas->num_rows>0)
                                            {
                                                ...
                                                { 
                                                	$teacher_list = "../../Uploaded Documents/Criteria - 2/".$data['teacher_list'];

                                                	$student_list = "../../Uploaded Documents/Criteria - 2/".$data['student_list'];
                                                    $i++;
                                        			?>
                                        			<tr style="text-align:center;">
                                                    	...
                                                    	?></td>
                                                        <td>
                                                        	<a href="<?php echo $teacher_list?>" class="btn btn-success" download><i class="fa-solid fa-download"></i></a>&nbsp;&nbsp;

                                                        	<a href="<?php echo $teacher_list ?>" target = "_blank" class="btn btn-danger"><span id="warning_btn"><i class="fa-solid fa-eye"></i></span></a>&nbsp;&nbsp;
                                                        </td>
                                                        <td>
                                                        	<a href="<?php echo $student_list?>" class="btn btn-success" download><i class="fa-solid fa-download"></i></a>&nbsp;&nbsp;

                                                        	<a href="<?php echo $student_list ?>" target = "_blank" class="btn btn-danger"><span id="warning_btn"><i class="fa-solid fa-eye"></i></span></a>&nbsp;&nbsp;
                                                        </td>
                                                    </tr>
                                                    <?php 
                                                }
