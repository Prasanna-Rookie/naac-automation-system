...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	if(empty($academic_year_err) && empty($options_err))
	{
		...
		if(mysqli_query($con, $query))
		{
        	...
        	echo'alert("Uploaded Successfully."); location.href="cri_6.5.3_options.php"';
        	echo '</script>';
		}
		else
		{
			echo '<script language="javascript">';
	        echo'alert("Document Upload Failed, Please Try Again."); location.href="cri_6.5.3_options.php"';
	        echo '</script>';
		}
	}
}
...
if(isset($_POST['update']))
{
	...
	if(empty(trim($_POST["options"])))
	{
		$err++;
		echo '<script language="javascript">';
        echo'alert("Please Enter Budget Allocated."); location.href="cri_6.5.3_options.php"';
        echo '</script>';
	}
	else
	{
		if($err == 0)
		{
			...
			if(mysqli_stmt_execute($stmt)) {
			    echo '<script language="javascript">';
			    echo 'alert("Update Successfully."); location.href="cri_6.5.3_options.php"';
			    echo '</script>';
			} else {
			    echo '<script language="javascript">';
			    echo 'alert("Update Failed, Please Try Again."); location.href="cri_6.5.3_options.php"';
			    echo '</script>'; 
			}
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                        <label style="font-size: 17px; color:dimgrey; font-weight: bold;" class="control-label" for="options"><span style="color: red">* </span>Quality assurance initiatives</label>
						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_6.5.3_excel_report.php" id="non-active">Excel Report</a>
								</li>

								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_6.5.3_options.php" id="active">Options</a>
								</li>
											...
											<div class="col-sm-6 col-sm-6">
												<div class="card" style="border-top:2px solid #087ec2;">
													...
													<div class="card-body">
														...
														<div class="mb-3">
                                                        	<label class="form-label" for="options"><span style="color: red">* </span>Quality assurance initiatives </label>
