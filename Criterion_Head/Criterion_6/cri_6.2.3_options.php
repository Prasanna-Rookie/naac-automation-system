...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	else
	{
		$academic_year_t = $_POST["academic_year"];
       	$query = "SELECT * FROM cri_6_choice WHERE academic_year = '$academic_year_t' and metric = '$metric'";
	...
	{
		$query = "INSERT INTO cri_6_choice (academic_year, metric, upload_by_id, upload_by_name, choice) VALUES ('$academic_year','$metric', '$upload_by_id', '$upload_by_name','$options')";
		if(mysqli_query($con, $query))
		{
			echo '<script language="javascript">';
        	echo'alert("Uploaded Successfully."); location.href="cri_6.2.3_options.php"';
        	echo '</script>';
		}
		else
		{
			echo '<script language="javascript">';
	        echo'alert("Document Upload Failed, Please Try Again."); location.href="cri_6.2.3_options.php"';
	        echo '</script>';
		}
	}
}
...
if(isset($_POST['update']))
{
	...
	if(empty(trim($_POST["options"])))
	{
		$err++;
		echo '<script language="javascript">';
        echo'alert("Please Enter Budget Allocated."); location.href="cri_6.2.3_options.php"';
        echo '</script>';
	}
	else
	{
		if($err == 0)
		{
			...
			$query = "UPDATE cri_6_choice SET choice = ? WHERE choice_id = ?";
			...
			if(mysqli_stmt_execute($stmt)) {
			    echo '<script language="javascript">';
			    echo 'alert("Update Successfully."); location.href="cri_6.2.3_options.php"';
			    echo '</script>';
			} else {
			    echo '<script language="javascript">';
			    echo 'alert("Update Failed, Please Try Again."); location.href="cri_6.2.3_options.php"';
			    echo '</script>'; 
			}
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-light" style="border-top:3.5px solid #087ec2;">
                        <h6 class="modal-title" id="exampleModalLabel" style="color:#057EC5;"><i class="fa fa-edit"></i><spam>Implementation of E-governance in areas of operation</spam></h6>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                        <label style="font-size: 17px; color:dimgrey; font-weight: bold;" class="control-label" for="options"><span style="color: red">* </span>Implementation of E-governance in areas of operation</label>
						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_6.2.3_excel_report.php" id="non-active">Excel Report</a>
								</li>

								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_6.2.3_options.php" id="active">Options</a>
								</li>
										...
										<div class="row justify-content-center">
											<div class="col-sm-6 col-sm-6">
												<div class="card" style="border-top:2px solid #087ec2;">
													<div class="card-header" style="color:#087ec2; font-weight:bold;">
														<i class="fas fa-puzzle-piece fa-lg"></i>
														<span>Criteria 6.2.3 - Implementation of E-governance in areas of operation</span>
													</div>
													<div class="card-body">
														<div class="mb-3">
														...
														<div class="mb-3">
                                                        	<label class="form-label" for="options"><span style="color: red">* </span>Implementation of E-governance in areas of operation</label>
							...
							$sql = "SELECT * FROM cri_6_choice WHERE upload_by_id = '$upload_by_id' and metric = '$metric'";
							$datas = $con->query($sql);
							if($datas->num_rows>0)
							{
								?>
									...
									<table class="table table-bordered" id="table">
										<thead style="background-color:#057EC5; color:#FFF;">
											<tr align="center">
												<th>Academic Year</th>
												<th>Option</th>
												<th>Implementation of E-governance </th>
												<th>Update</th>
											</tr>
										</thead>
