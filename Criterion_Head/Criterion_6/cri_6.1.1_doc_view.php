...
if (isset($_GET['delete'])) 
{
    ...
    $sql = "SELECT * FROM cri_6_1_1_doc_upload WHERE doc_id = '$id'";
    $data = $con->query($sql);
    ...
    {
    	$sql = "DELETE FROM cri_6_1_1_doc_upload WHERE doc_id = '$id'";
    	if ($con->query($sql) === TRUE) 
	    {
	        echo '<script language="javascript">';
        	echo'alert("Document Deleted Successfully."); location.href="cri_6.1.1_doc_view.php"';
        	echo '</script>';
	    } 
    }
    else
    {
    	echo '<script language="javascript">';
        echo'alert("Document Deleted Failed, Please Try Again."); location.href="cri_6.1.1_doc_view.php"';
        echo '</script>';
    }
}
?>
					...
					<div class="card" style="border-top:2px solid #087ec2;">
						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_6.1.1_doc_upload.php" id="non-active">Upload Document</a>
								</li>

								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_6.1.1_doc_view.php" id="active">View Document</a>
								</li>
                            	...
                            	<table class="table table-bordered" id="table">
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            $sql = "SELECT * FROM cri_6_1_1_doc_upload ORDER BY academic_year, doc_id";   
