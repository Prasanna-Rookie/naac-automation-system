...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	if(empty($academic_year_err) && empty($description_err) && empty($pdf_file_err))
	{
		...
		{
			$query = "INSERT INTO cri_6_2_2_doc_upload (academic_year, description, upload_by_id, upload_by_name, doc_name) VALUES ('$academic_year', '$description', '$upload_by_id', '$upload_by_name','$pdf_file_name')";
			if(mysqli_query($con, $query))
			{
				echo '<script language="javascript">';
        		echo'alert("Document Uploaded Successfully."); location.href="cri_6.2.2_doc_upload.php"';
        		echo '</script>';
			}
			else
			{
				echo '<script language="javascript">';
	        	echo'alert("Document Upload Failed, Please Try Again."); location.href="cri_6.2.2_doc_upload.php"';
	        	echo '</script>';
			}
		}
	}
				...
				<div class="container-fluid">
					<div class="card" style="border-top:2px solid #087ec2;">
						...
						<div class="card-header" style="color:#087ec2; font-weight:bold;">
							...
							<span>Criteria 6.2.2 - The functioning of the various institutional bodies is effective and efficient as visible from the policies, administrative set-up, appointment and service rules, procedures, etc.</span>
						</div>
						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_6.2.2_writeup.php" id="non-active">Write Up</a>
								</li>

								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_6.2.2_doc_upload.php" id="active">Upload Document</a>
								</li>

								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_6.2.2_doc_view.php" id="non-active">View Document</a>
								</li>
										...
										<div class="col-sm-6 col-sm-6">
											<div class="card" style="border-top:2px solid #087ec2;">
												<div class="card-header" style="color:#087ec2; font-weight:bold;">
	                        						...
	                        						<span>Criteria 6.2.2 - Upload Document</span>
												</div>
												<div class="card-body">
