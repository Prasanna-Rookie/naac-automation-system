						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_5.1.1_excel_report.php" id="active">Excel Report</a>
								</li>
                                        ...
                                        <div class="col-sm-6 col-sm-6">
                                            <div class="card" style="border-top:2px solid #087ec2;">
                                                <div class="card-header" style="color:#087ec2; font-weight:bold;">
                                                    ...
                                                    <span>Criteria 5.1.1 - Report</span>
                                                </div>
                            		...
                            		<table class="table table-bordered" id="table">
                            			<thead style="background-color:#057EC5; color:#FFF;">
                            				<tr>
                            					...
                            					<th>Amount provided by the Government</th>
                            					<th>Number of students receiving scholarships and freeships provided by the institution</th>
                            					<th>Amount provided by the institution</th>
                            					<th>Number of students receiving scholarships and freeships provided by non-government agencies</th>
                            					<th>Amount provided by non-government agencies</th>
                            					<th>Name of the NGO/Agency</th>
                            				</tr>
                            			</thead>
                            			<tbody class="row_position">
                            				<?php 
                            					$sql = "SELECT * FROM cri_5_1_1_scholarships WHERE academic_year = '$academic_year' ORDER BY (CASE 
                            						WHEN type = 'Government' THEN 1
                            						WHEN type = 'Institution' THEN 2
                            						ELSE 3 END)";
