						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_5.1.4_excel_report.php" id="active">Excel Report</a>
								</li>
                                        ...
                                        <div class="col-sm-6 col-sm-6">
                                            <div class="card" style="border-top:2px solid #087ec2;">
                                                <div class="card-header" style="color:#087ec2; font-weight:bold;">
                                                    ...
                                                    <span>Criteria 5.1.4 - Report</span>
                                                </div>
                            	...
                            	<div class="table-responsive">
                            		<table class="table table-bordered" id="table">
                            			...
                            			<tbody class="row_position">
                            				<?php 
                            					$sql = "SELECT * FROM cri_5_1_5_students_benefitted WHERE academic_year = '$academic_year' ORDER BY (CASE 
                            						WHEN type = 'Competitive Examinations' THEN 1
                            						WHEN type = 'Career Counselling' THEN 2
                            						ELSE 3 END)";
	                                            ...
	                                            if($datas->num_rows>0)
	                                            {
	                                                ...
	                                                {  
	                                                    $i++;
	                                                    if($data['type'] == "Competitive Examinations")
	                                                    {
	                                                    	?>
