...
require '../../config.php';
$academic_year = $academic_year_err = $collaborating_agency = $collaborating_agency_err = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	{
		$collaborating_agency_err = "Please Enter Name of the Workshop/ Seminar.";
	}
	else
	{
	...
	// Insert
	if(empty($academic_year_err) && empty($collaborating_agency_err))
	{
		$query = "INSERT INTO cri_3_7_1_collaborating_agency (academic_year, upload_by_id, upload_by_name, collaborating_agency) VALUES ('$academic_year', '$upload_by_id', '$upload_by_name','$collaborating_agency')";
		if(mysqli_query($con, $query))
		{
			echo '<script language="javascript">';
			echo'alert("Uploaded Successfully."); location.href="cri_3.7.1_collaborating_agency.php"';
			echo '</script>';
		}
		else
		{
			echo '<script language="javascript">';
			echo'alert("Upload Failed, Please Try Again."); location.href="cri_3.7.1_collaborating_agency.php"';
			echo '</script>';
		}
...
if(isset($_POST['update']))
{
	...
	if(empty(trim($_POST["collaborating_agency"])))
	{
		$err++;
		echo '<script language="javascript">';
        echo'alert("Please Fill the all Fields."); location.href="cri_3.7.1_collaborating_agency.php"';
        echo '</script>';
	}
	else
	{
		if($err == 0)
		{
			...
			$query = "UPDATE cri_3_7_1_collaborating_agency SET collaborating_agency = ?  WHERE ca_id = ?";
			$stmt = mysqli_prepare($con, $query);
			mysqli_stmt_bind_param($stmt, "si", $collaborating_agency, $id);
			if(mysqli_stmt_execute($stmt)) 
			{
			    echo '<script language="javascript">';
			    echo 'alert("Update Successfully."); location.href="cri_3.7.1_collaborating_agency.php"';
			    echo '</script>';
			} 
			else 
			{
			    echo '<script language="javascript">';
			    echo 'alert("Update Failed, Please Try Again."); location.href="cri_3.7.1_collaborating_agency.php"';
			    echo '</script>'; 
			}
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                    	...
                    	<div class="mb-3">
                            <label class="form-label" style="font-size: 17px; color:dimgrey; font-weight: bold;" for = "collaborating_agency"> <span style="color: red">* </span>Name of the collaborating agency with contact details</label>

                            <input type="text" name="collaborating_agency" class="form-control " id="collaborating_agency">
                        </div>
						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_3.7.1_collaborating_agency.php" id="active">Collaborating Agency</a>
								</li>

								<li class="nav-item" role="presentation">
									<a class="nav-link" href="cri_3.7.1_stdents.php" id="non-active">Students</a>
								</li>
												...
												<div class="card" style="border-top:2px solid #087ec2;">
													...
													<div class="card-body">
														...
														<div class="mb-3">
															...
															class="form-control <?php echo (!empty($collaborating_agency_err)) ? 'is-invalid' : ''; ?>"
															id = "collaborating_agency" 
															value = "<?php echo $collaborating_agency; ?>">
							...
							<?php
							$sql = "SELECT * FROM cri_3_7_1_collaborating_agency WHERE upload_by_id = '$upload_by_id'";
							$datas = $con->query($sql);
							if($datas->num_rows>0)
							{
								?>
										...
										<tbody class="row_position">
											...
											while ($data = $datas->fetch_assoc()) 
											{
												...
												<tr style="text-align:center;">
													...
													<?php
													echo"<td><button type='button' class='btn btn-sm btn-success edit' data-id={$data["ca_id"]}><i class = 'fa fa-edit'></i></button></td>";
													?>
												</tr>
												<?php
											}
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$('.edit').on('click',function(){
			...
			$('#collaborating_agency').val(data[1]);
		});
	});
</script>
