...
EOD;
        ...
        $query = "SELECT d.programme_code, d.programme_name,c.academic_year, c.course_code, c.course_name, c.course_type FROM programme_info AS d LEFT JOIN cri_1_3_1_courses AS c ON c.programme_code = d.programme_code WHERE c.academic_year = '$academic_year' and c.programme_code = '$upload_by' ORDER BY c.id ASC";
...
EOD;
        ...
        $query = "SELECT activity_name, organizing_unit, relevant_event, activity_date FROM cri_1_3_1_events WHERE academic_year = '$academic_year' and upload_by = '$upload_by' ORDER BY activity_date";
