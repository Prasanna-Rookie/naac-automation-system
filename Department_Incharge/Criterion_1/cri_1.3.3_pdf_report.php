...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	if(empty($academic_year_err))
	{
		...
		$sql = "SELECT doc_name FROM cri_1_3_3_doc_upload WHERE academic_year = '$academic_year' and department = '$upload_by' ORDER BY id";
		...
		$result = mysqli_query($con, $sql);
            ...
            if(mysqli_num_rows($result) > 0)
            {
                ...
                $file = uniqid().'.pdf';
                $pdf->Output('D', '1.3.3 - '.$academic_year.' - .pdf');
            }
            else
            {
                echo '<script language="javascript">';
                echo'alert("No Documents Founded."); location.href="cri_1.3.3_pdf_report.php"';
                echo '</script>';
            }
					...
					<div class="card" style="border-top:2px solid #087ec2;">
						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_1.3.3_pdf_report.php" id="active">PDF Report</a>
								</li>
                                        ...
                                        <div class="col-sm-6 col-sm-6">
                                            <div class="card" style="border-top:2px solid #087ec2;">
                                                <div class="card-header" style="color:#087ec2; font-weight:bold;">
                                                    ...
                                                    <span>Criteria 1.3.3 - Report</span>
                                                </div>
