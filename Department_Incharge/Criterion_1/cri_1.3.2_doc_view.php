...
if (isset($_GET['delete'])) 
{
    ...
    $sql = "SELECT * FROM cri_1_3_2_value_added_courses WHERE id = '$id'";
    $data = $con->query($sql);
    ...
    {
    	$sql = "DELETE FROM cri_1_3_2_value_added_courses WHERE id = '$id'";
    	if ($con->query($sql) === TRUE) 
	    {
	        echo '<script language="javascript">';
        	echo'alert("Document Deleted Successfully."); location.href="cri_1.3.2_add_course.php"';
        	echo '</script>';
	    } 
    }
    else
    {
    	echo '<script language="javascript">';
        echo'alert("Document Deleted Failed, Please Try Again."); location.href="cri_1.3.2_add_course.php"';
        echo '</script>';
    }
}
?>
                        ...
                        <div class = "card-body">
							<ul class="nav nav-tabs">
	                            <li class="nav-item" role="presentation">
	                                <a class="nav-link" href="cri_1.3.2_value_added_course.php" id="non-active">Add Course</a>
	                            </li>

	                            <li class="nav-item" role="presentation">
	                                <a class="nav-link active" href="cri_1.3.2_doc_view.php" id="active">View Document</a>
	                            </li>
	                            <li class="nav-item" role="presentation">
                            	...
                            	<table class="table table-bordered" id="table">
                                    ...
                                    <tbody class="row_position">
                                        <?php 
                                            ...
                                            $sql = "SELECT * FROM cri_1_3_2_value_added_courses WHERE department = '$department' ORDER BY id";
                                            $datas = $con->query($sql);
                                            if($datas->num_rows>0)
                                            {
                                                $i=0;
