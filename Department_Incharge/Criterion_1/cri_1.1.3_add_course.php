...
if($_SERVER["REQUEST_METHOD"] == "POST")       
{
    ...
    if(empty($academic_year_err) && empty($course_name_err) && empty($course_code_err) && empty($course_category_err) && empty($file_err))
    {
        ...
        if(move_uploaded_file($pdf_tem_loc,$upload_location))
        {
            ...
            $query = "INSERT INTO cri_1_1_3_course (academic_year, department, course_name, course_code, course_category, doc_name) VALUES ('$academic_year', '$department', '$course_name', '$course_code', '$course_category', '$file_name')";

            if(mysqli_query($con, $query))
            {
                echo '<script language="javascript">';
                echo'alert("Course Added Successfully."); location.href="cri_1.1.3_add_course.php"';
                echo '</script>';
            }
            else
            {
                echo '<script language="javascript">';
                echo'alert("Failed, Please Try Again."); location.href="cri_1.1.3_add_course.php"';
                echo '</script>';
            }
            mysqli_close($con);
        }    
                        ...
                        <div class="card-body">
	                        <ul class="nav nav-tabs">
	                            <li class="nav-item" role="presentation">
	                                <a class="nav-link active" href="cri_1.1.3_add_course.php" id="active">Add Course</a>
	                            </li>

	                            <li class="nav-item" role="presentation">
	                                <a class="nav-link" href="cri_1.1.3_doc_view.php" id="non-active">View Document</a>
	                            </li>
	                            <li class="nav-item" role="presentation">
