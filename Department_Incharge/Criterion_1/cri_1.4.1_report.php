...
if($_SERVER["REQUEST_METHOD"] == "POST")   	
{
    ...
    if(empty($academic_year_err) && empty($doc_type_err))
    {
    	...
    	{
    		$sql = "SELECT stu_sample FROM cri_1_4_1_doc_upload WHERE academic_year = '$academic_year' AND upload_by = '$upload_by'";
	        ...
	        if(mysqli_num_rows($result) > 0)
	        {
	            while ($row = $result -> fetch_assoc()) 
	            {
	                ...
	                $file_path = "../../Uploaded Documents/Criterion - 1/".$file_name;
    	...
    	{
    		$sql = "SELECT tea_sample FROM cri_1_4_1_doc_upload WHERE academic_year = '$academic_year' AND upload_by = '$upload_by'";
    	...
    	{
    		$sql = "SELECT emp_sample FROM cri_1_4_1_doc_upload WHERE academic_year = '$academic_year' AND upload_by = '$upload_by'";
    	...
    	{
    		$sql = "SELECT alu_sample FROM cri_1_4_1_doc_upload WHERE academic_year = '$academic_year' AND upload_by = '$upload_by'";
                                        ...
                                        <div class="col-sm-6 col-sm-6">
                                            <div class="card" style="border-top:2px solid #087ec2;">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="mb-3">
	                        							<label class="form-label" style="font-size: 17px; color:dimgrey; font-weight: bold;" for = "academic_year"> <span style="color: red">* </span>Academic Year
	                        							</label>
                                                    ...
                                                    <div class="mb-3">
                                                        <label style="font-size: 17px; color:dimgrey; font-weight: bold;" class="control-label" for="doc_type"><span style="color: red">* </span>Report Type
                                                        </label>
