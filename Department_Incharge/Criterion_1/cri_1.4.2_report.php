...
if($_SERVER["REQUEST_METHOD"] == "POST")   	
{
    ...
    if(empty($academic_year_err) && empty($doc_type_err))
    {
        ...
        {
            $sql = "SELECT doc_name FROM cri_1_4_2_doc_upload WHERE academic_year = '$academic_year' AND doc_type = 'Feedback Analysis' AND upload_by = '$upload_by'";
        ...
        {
            $sql = "SELECT doc_name FROM cri_1_4_2_doc_upload WHERE academic_year = '$academic_year' AND doc_type = 'Evidences' AND upload_by = '$upload_by'";
