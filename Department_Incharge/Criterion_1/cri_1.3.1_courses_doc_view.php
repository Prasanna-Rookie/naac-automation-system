...
if (isset($_GET['delete'])) 
{
    ...
    $sql = "SELECT * FROM  cri_1_3_1_courses WHERE id = '$id'";
    $data = $con->query($sql);
    ...
    {
    	$sql = "DELETE FROM  cri_1_3_1_courses WHERE id = '$id'";
    	if ($con->query($sql) === TRUE) 
	    {
	        echo '<script language="javascript">';
        	echo'alert("Document Deleted Successfully."); location.href="cri_1.3.1_courses_doc_view.php"';
        	echo '</script>';
	    } 
    }
    else
    {
    	echo '<script language="javascript">';
        echo'alert("Document Deleted Failed, Please Try Again."); location.href="cri_1.3.1_courses_doc_view.php"';
        echo '</script>';
    }
}
						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
	                                <a class="nav-link" href="cri_1.3.1_courses.php" id="non-active">Relevant to Courses</a>
	                            </li>

	                            <li class="nav-item" role="presentation">
                                    <a class="nav-link active" href="cri_1.3.1_courses_doc_view.php" id="active">View Document (Courses)</a>
                                </li>
                            	...
                            	<table class="table table-bordered" id="table">
                                    ...
                                    <tbody class="row_position">
                                        <?php 
                                            ...
                                            $sql = "SELECT * FROM cri_1_3_1_courses WHERE programme_code = '$department' ORDER BY id";
                                            $datas = $con->query($sql);
                                            if($datas->num_rows>0)
                                            {
                                                $i=0;
...
cri_1.3.1_courses_doc_view.php