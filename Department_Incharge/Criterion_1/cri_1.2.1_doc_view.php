...
if (isset($_GET['delete'])) 
{
    ...
    $sql = "SELECT * FROM cri_1_2_1_course WHERE id = '$id'";
    $data = $con->query($sql);
    ...
    {
    	$sql = "DELETE FROM cri_1_2_1_course WHERE id = '$id'";
    	if ($con->query($sql) === TRUE) 
	    {
	        echo '<script language="javascript">';
        	echo'alert("Document Deleted Successfully."); location.href="cri_1.2.1_doc_view.php"';
        	echo '</script>';
	    } 
    }
    else
    {
    	echo '<script language="javascript">';
        echo'alert("Document Deleted Failed, Please Try Again."); location.href="cri_1.2.1_doc_view.php"';
        echo '</script>';
    }
}
?>
                        ...
                        <div class = "card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
	                                <a class="nav-link" href="cri_1.2.1_add_course.php" id="non-active">Add Course</a>
	                            </li>

	                            <li class="nav-item" role="presentation">
	                                <a class="nav-link active" href="cri_1.2.1_doc_view.php" id="active">View Document</a>
	                            </li>
	                            <li class="nav-item" role="presentation">
                            	...
                            	<table class="table table-bordered" id="table">
                                    ...
                                    <tbody class="row_position">
                                        <?php 
                                            ...
                                            $sql = "SELECT * FROM cri_1_2_1_course WHERE department = '$department' ORDER BY id";
