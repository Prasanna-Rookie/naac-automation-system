...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	if(empty($academic_year_err) && empty($pdf_file_err))
	{
		...
		{
			$doc_type = "Circulars";
			$query = "INSERT INTO cri_2_4_1_doc_upload (academic_year, upload_by, doc_name) VALUES ('$academic_year', '$upload_by','$pdf_file_name')";
			if(mysqli_query($con, $query))
			{
				echo '<script language="javascript">';
        		echo'alert("Document Uploaded Successfully."); location.href="cri_2.4.1_doc_upload.php"';
        		echo '</script>';
			}
			else
			{
				echo '<script language="javascript">';
	        	echo'alert("Document Upload Failed, Please Try Again."); location.href="cri_2.4.1_doc_upload.php"';
	        	echo '</script>';
			}
		}
		else
						...
						<div class="card-body">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
		                            <a class="nav-link" href="cri_2.4.1_sanctioned_posts.php" id="non-active">Sanctioned Posts</a>
		                        </li>

	                            <li class="nav-item" role="presentation">
	                                <a class="nav-link active" href="cri_2.4.1_doc_upload.php" id="active">Document Upload</a>
	                            </li>
										...
										<div class="col-sm-6 col-sm-6">
											<div class="card" style="border-top:2px solid #087ec2;">
												<div class="card-header" style="color:#087ec2; font-weight:bold;">
	                        						...
	                        						<span>Criteria 2.4.1 - Document Upload</span>
												</div>
