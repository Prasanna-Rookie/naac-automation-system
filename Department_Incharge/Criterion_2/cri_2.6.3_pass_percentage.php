                        ...
                        <div class="card-body">
	                        <ul class="nav nav-tabs">
	                            <li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_2.6.3_pass_percentage.php" id="active">Pass Percentage</a>
								</li>
	                        		...
	                        		<div class="row justify-content-center">
	                        			<div class="col-sm-6 col-sm-6">
	                        				<div class="card" style="border-top:2px solid #087ec2;">
	                        					...
	                        					<div class="card-body">
	                        						<form method="post" action="cri_2.6.3_student_export.php" autocomplete = "off" enctype="multipart/form-data">
	                        			...
	                        			<div class="col-sm-6 col-sm-6">
	                        				<div class="card" style="border-top:2px solid #087ec2;">
	                        					...
	                        					<div class="card-body">
	                        						<form method="post" action="cri_2.6.3_student_import.php" autocomplete = "off" enctype="multipart/form-data">
