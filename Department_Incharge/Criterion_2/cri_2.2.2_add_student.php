                    ...
                    <div class="card" style="border-top:2px solid #087ec2;">
                        ...
                        <div class="card-body">
	                        <ul class="nav nav-tabs">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="cri_2.2.2_add_student.php" id="active">Add Student</a>
								</li>
	                        		...
	                        		<div class="row justify-content-center">
	                        			<div class="col-sm-6 col-sm-6">
	                        				<div class="card" style="border-top:2px solid #087ec2;">
	                        					...
	                        					<div class="card-body">
	                        						<form method="post" action="cri_2.2.2_student_export.php" autocomplete = "off" enctype="multipart/form-data">
	                        			...
	                        			<div class="col-sm-6 col-sm-6">
	                        				<div class="card" style="border-top:2px solid #087ec2;">
	                        					...
	                        					<div class="card-body">
	                        						<form method="post" action="cri_2.2.2_student_import.php" autocomplete = "off" enctype="multipart/form-data">
