...
if(isset($_POST['export']))        
{
    ...
    if($error == 0)
    {
		...
		fputcsv($output, array('Reg.NO', 'Name'));
		$query = "SELECT reg_no, name from cri_2_1_1_student_details WHERE programme_code = '$department' AND academic_year = '$academic_year' ORDER BY reg_no";
